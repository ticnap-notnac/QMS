      ...
      >
        ...
        <div className="modal-form-content" style={{ flex: 1, overflowY: 'auto', paddingRight: '4px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{
            ...
            <div><span style={{ color: 'var(--muted)' }}>Requesting Dept:</span> <strong style={{ color: '#f8fafc' }}>{car.requesting_department || '—'}</strong></div>
            <div><span style={{ color: 'var(--muted)' }}>Responsible Dept:</span> <strong style={{ color: '#f8fafc' }}>{car.responsible_department || '—'}</strong></div>
            <div><span style={{ color: 'var(--muted)' }}>Requestor:</span> <strong style={{ color: '#f8fafc' }}>{car.requestor || '—'}</strong></div>
            <div><span style={{ color: 'var(--muted)' }}>Recipient:</span> <strong style={{ color: '#f8fafc' }}>{car.recipient || '—'}</strong></div>
            <div><span style={{ color: 'var(--muted)' }}>Product / Material:</span> <strong style={{ color: '#f8fafc' }}>{car.product_material_name || '—'}</strong></div>
            <div><span style={{ color: 'var(--muted)' }}>Model / Type:</span> <strong style={{ color: '#f8fafc' }}>{car.model_type || '—'}</strong></div>
            <div><span style={{ color: 'var(--muted)' }}>Control No.:</span> <strong style={{ color: '#f8fafc' }}>{car.control_no || '—'}</strong></div>
            <div><span style={{ color: 'var(--muted)' }}>Affected Qty:</span> <strong style={{ color: '#f8fafc' }}>{car.affected_quantity || '—'}</strong></div>
            <div style={{ gridColumn: 'span 2' }}><span style={{ color: 'var(--muted)' }}>Request Date:</span> <strong style={{ color: '#f8fafc' }}>{car.request_date ? new Date(car.request_date).toLocaleDateString() : '—'}</strong></div>
          </div>
          ...
          {car.status === 'open' ? (
            isUserRecipient ? (
              ...
              <div className="empty-state" style={{ padding: '16px', background: 'rgba(255,255,255,0.01)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: '16px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '12px' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    ...
                    <div style={{ padding: '10px', background: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.04)', borderRadius: '6px', fontSize: '13px', color: '#cbd5e1' }}>
          ...
          {car.status === 'closed' && car.verification_notes && (
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontStyle: 'italic', color: '#cbd5e1' }}>"{car.verification_notes}"</div>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '8px', fontSize: '11px', color: 'var(--muted)' }}>
