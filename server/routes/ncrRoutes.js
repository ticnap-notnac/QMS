...
router.put('/ncr/:id/assign', requireRoles(['admin', 'auditor', 'warehouse supervisor'], 'assign_report'), validateRequest(assignReportSchema), assignReport)
router.put('/ncr/:id/approval', requireRoles(['admin', 'auditor', 'manager', 'department manager', 'team leader', 'warehouse executive', 'warehouse supervisor'], 'accept_decline_report'), validateRequest(reviewReportApprovalSchema), reviewReportApproval)
